...
namespace HomeService.Controllers
{
    ...
    public class ContractsController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get(int customerId,DataSourceLoadOptions loadOptions) {
            var contract = _context.Contract.Where(c=>c.CustomerId== customerId).Select(i => new {
                i.ContractId,
                i.ContractSerial,
                i.CustomerId,
                i.UnitId,
